...
export default function Page({
    ...
    return (
        <>
            <h1>The multiplayer mode is under a huge revamp</h1>
            {/* <LayoutOne gameOn={lobby && lobby?.started && !stopped}>
                {user ? (
                    lobby && lobby?.started && !stopped ? (
                        ...
                        <div className="flex items-center gap-8 justify-center h-full w-full flex-wrap">
                            <button
                                className={`bg-primary-50 hover:cursor-pointer hover:bg-primary transition-all p-[25px] text-white font-xl rounded-3xl`}
                            ...
                            >
                                <FontAwesomeIcon icon={faArrowRightToBracket} className="h-[80px] w-auto" />
                                <h3>Join Lobby</h3>
                            </button>
                        </div>
                    )
